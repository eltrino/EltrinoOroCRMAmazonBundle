...
class OroCRMAmazonBundle implements Migration
{
    ...
    public static function createAmazonOrderTable(Schema $schema)
    {
        ...
        $table->addColumn('ship_service_lev', 'string', ['length' => 300]);
        $table->addColumn('ship_service_lev_cat', 'string', ['length' => 300]);
        $table->addColumn('num_items_shipped', 'integer', ['notnull' => false]);
        $table->addColumn('num_items_unshipped', 'integer', ['notnull' => false]);
    ...
    public static function createAmazonOrderItemTable(Schema $schema)
    {
        ...
        $table->addColumn('gift_price_currency', 'string', ['notnull' => false, 'length' => 32]);
        ...
        $table->addColumn('cod_fee_disc_currency', 'string', ['notnull' => false, 'length' => 32]);
        $table->addColumn('cod_fee_disc_amount', 'float', ['notnull' => false]);
        ...
        $table->addColumn('item_price_currency', 'string', ['notnull' => false, 'length' => 32]);
        $table->addColumn('item_price_amount', 'float', ['notnull' => false]);
        $table->addColumn('item_condition', 'string', ['notnull' => false, 'length' => 32]);
        $table->addColumn('ship_price_currency', 'string', ['notnull' => false, 'length' => 32]);
        $table->addColumn('ship_price_amount', 'float', ['notnull' => false]);
        $table->setPrimaryKey(['id']);
